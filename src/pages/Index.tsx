...
const ClientJourneySection = lazy(() => import("@/components/sections/ClientJourneySection"));
const TestimonialsSection = lazy(() => import("@/components/sections/TestimonialsSection"));
const LegalSection = lazy(() => import("@/components/sections/LegalSection"));
const ConsultationForm = lazy(() => import("@/components/sections/ConsultationForm"));
const TelegramBotSection = lazy(() => import("@/components/sections/TelegramBotSection"));
...
const ExitIntentModal = lazy(() => import("@/components/modals/ExitIntentModal"));
const FAQSection = lazy(() => import("@/components/sections/FAQSection"));
const MethodologySection = lazy(() => import("@/components/sections/MethodologySection"));
const AboutMeSection = lazy(() => import("@/components/sections/AboutMeSection"));
const AnalyticsDashboard = lazy(() => import("@/components/AnalyticsDashboard"));
const LeadsExportPanel = lazy(() => import("@/components/LeadsExportPanel"));
const WarmupPreview = lazy(() => import("@/components/WarmupPreview"));
const PauseReminder = lazy(() => import("@/components/Popups/PauseReminder"));
