              ...
              {[
                {
                  ...
                  description: "Создаю чат-боты с логикой квалификации клиентов, автоответами, записью на консультацию, допродажами. Интеграция с CRM, аналитикой и платёжными системами. Автоматизирую обработку заявок и прогрев аудитории через Telegram-боты и автоворонки.",
                  features: ["Логика сегментации и автоматизации клиентов", "Авто-квалификация и прогрев через Telegram-боты", "Интеграция Telegram-ботов с CRM и оплатами"]
                },
                {
                  icon: "Video",
                  color: "from-purple-500 to-pink-500",
                  title: "Видео-лендинги и сайты",
                  description: "Разрабатываю продающие страницы с видео-прогревом, которые держат внимание 30–90 секунд и ведут клиента к целевому действию без лишних кликов. Видео-лендинги интегрируются с чат-ботами и автоворонками для увеличения конверсии.",
                ...
                },
                {
                  ...
                  description: "Запускаю контекстную рекламу (Яндекс Директ, Google Ads), таргетированную рекламу и тизерные сети. Настраиваю трафик на автоворонки с интеграцией Telegram-ботов. Только белые ниши, легальные связки.",
                  features: ["Контекстная реклама: Яндекс Директ, Google Ads", "Таргетированный трафик: ВК, Telegram Ads", "Интеграция трафика с чат-ботами и автоворонками"]
                },
                {
                  icon: "Zap",
                  color: "from-green-500 to-emerald-500",
                  title: "Консалтинг и оптимизация",
                  description: "Аудит текущих автоворонок, советы по структуре оффера, триггерам, сценариям в Telegram-ботах и чат-ботах. Помогаю повысить конверсию на каждом этапе автоматизации — от креатива до закрытия сделки.",
                  features: ["Аудит автоворонок и чат-ботов", "Оптимизация Telegram-ботов и трафика", "Чек-листы для масштабирования автоматизации"]
                },
              ].map((service, i) => (
                <motion.div
                  key={i}
