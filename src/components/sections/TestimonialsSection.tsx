    ...
    >
      <Card className={`p-7 ${glassStyle.base} ${glassStyle.shadow} ${glassStyle.hover} border-white/[0.08] group h-full relative overflow-hidden`}>
        ...
        <div className="relative z-10">
          ...
          <motion.div 
            className={`absolute ${testimonial.name === 'Алексей Морозов' ? 'top-5' : 'top-3'} right-1.5 md:top-6 md:right-6 md:absolute px-3.5 py-2 rounded-lg backdrop-blur-sm group-hover:scale-105 transition-transform duration-300`}
            style={{ 
