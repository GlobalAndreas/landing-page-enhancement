...
const TestimonialCard = ({ testimonial, index }: { testimonial: typeof testimonials[0], index: number }) => {
  ...
  return (
    <motion.div
      ...
      className="h-full"
    >
      <Card className={`p-7 pt-20 md:pt-7 ${glassStyle.base} ${glassStyle.shadow} ${glassStyle.hover} border-white/[0.08] group h-full relative overflow-hidden`}>
        ...
        <div className="relative z-10">
          ...
          <motion.div 
            className="absolute top-3 right-3 md:top-6 md:right-6 px-3.5 py-2 rounded-lg backdrop-blur-sm group-hover:scale-105 transition-transform duration-300"
            style={{ 
